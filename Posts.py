...
# this is the things that belong to all the types of posts
class Posts(ABC):
    ...
    @abstractmethod
    def display(self):                  #all post have another display
        pass


    def like(self, user):                       #add new like
        try:
    ...
    def comment(self, user, text):              #add new comment
        try:
