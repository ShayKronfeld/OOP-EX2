...
# here we use in observer design
...
class Users:
    ...
    def publish_post(self, post_type, *args):
        if not self.connecting_status:                                  #He is not allowed to publish post
        ...
        for follower in self.followers:
            follower.add_notify(f"{self.username} has a new post")
    ...
    def __str__(self):                                  #print the values of the user
        names = self.username
